...
class nzb_search_helper:
    ...
    def __init__(self):
        ...
        self.sql_movies = "SELECT z.ID, z.download_date, z.series_id, z.description, z.filename, z.password, z.nzb_address, z.Link, z.nzb_exception FROM nzb_search_dev.nzb_search z WHERE series_id = " + str(self.app_series_value) + " AND nzb_exception IS NULL AND download_date = '" + self.app_current_date_value + "';"
        # self.sql_movies = "SELECT * FROM nzb_search ns WHERE series_id = " + str(self.app_series_value) + " AND nzb_exception IS NULL AND download_date = '" + self.app_current_date_value + "';"
